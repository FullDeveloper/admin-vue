    ...
    <div class="app-container calendar-list-container">
        ...
        <el-table key='tableKey' :data="list" align="center" label="序号" width="65" v-loading="listLoading"
                  ...
                  border fit highlight-current-row style="width: 100%">
                    ...
                    <el-table-column width="200px" align="center" label="部门简称">
                        <template slot-scope="scope">
                            <span>{{scope.row.simpleName}}</span>
                        </template>
                    </el-table-column>
                    <el-table-column width="200px" align="center" label="部门全称">
                        <template slot-scope="scope">
                            <span>{{scope.row.fullName}}</span>
                        </template>
                    </el-table-column>
                    <el-table-column width="200px" align="center" label="部门提示">
                        <template slot-scope="scope">
                            <span>{{scope.row.tips}}</span>
                        </template>
                    </el-table-column>
                    <el-table-column width="200px" align="center" label="版本信息">
                        <template slot-scope="scope">
                            <span>{{scope.row.version}}</span>
                        </template>
                    </el-table-column>
                    <el-table-column width="200px" align="center" label="父级编号">
                        <template slot-scope="scope">
                            <span>{{scope.row.pid}}</span>
                        </template>
                    </el-table-column>
                    <el-table-column width="200px" align="center" label="排序字段">
                        <template slot-scope="scope">
...
<script>
    import { fetchList, getObj, delObj, putObj, addObj } from '@/api/admin/dept'
